var VT = {
    ...
    setup: function () {
        ...
        var i;
        for (i in VT.segments) {
            JSVTS.Map.addMovable(VT.segments[i]);
        }
        for (i in VT.vehicles) {
...
for (var i=0; i<cases.length; i++) {
    (function (params) {
        QUnit.test("vehicle should detect other vehicle in range ahead of itself: " + JSON.stringify(params), function (assert) {
...
for (var i=0; i<cases.length; i++) {
    (function (params) {
        QUnit.test("vehicle should not detect other vehicle not in range ahead of itself: " + JSON.stringify(params), function (assert) {
            var veh = new JSVTS.Vehicle();
            VT.segments[0].attachMovable(veh, VT.segments[0].config.start, VT.segments[0].config.end);
            veh.velocity = params.velocity;
...
for (var i=0; i<cases.length; i++) {
    (function (params) {
        QUnit.test("vehicle should not detect other vehicles in range on next lane over: " + JSON.stringify(params), function (assert) {
...
for (var i=0; i<cases.length; i++) {
    (function (params) {
        QUnit.test("vehicle should not detect other vehicle not in range behind itself: " + JSON.stringify(params), function (assert) {
            var veh = new JSVTS.Vehicle();
            VT.segments[0].attachMovable(veh, VT.segments[0].config.start, VT.segments[0].config.end);
            veh.velocity = params.velocity;
...
for (var i=0; i<cases.length; i++) {
    (function (params) {
        QUnit.test("vehicle should not detect other vehicle in range behind itself: " + JSON.stringify(params), function (assert) {
            var veh = new JSVTS.Vehicle();
            VT.segments[0].attachMovable(veh, VT.segments[0].config.start, VT.segments[0].config.end);
            veh.velocity = params.velocity;
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("vehicle should detect other vehicle in range ahead of itself on segment with angled heading: " + JSON.stringify(p), function (assert) {
            VT.teardown();
            var seg1 = new JSVTS.Segment({
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("vehicle should not detect other vehicle in range behind itself on segment with angled heading: " + JSON.stringify(p), function (assert) {
            VT.teardown();
            var seg1 = new JSVTS.Segment({
                start: new THREE.Vector3(p.sx,p.sy,p.sz),
                end: new THREE.Vector3(p.ex,p.ey,p.ez),
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("vehicle should correctly calculate lookahead distance based on velocity: " + JSON.stringify(p), function (assert) {
            var v = new JSVTS.Vehicle();
            v.velocity = p.v;
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("heading difference should be difference between this and next segment: " + JSON.stringify(p), function (assert) {
            var v;
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("heading difference should be 0 when segments not in range: " + JSON.stringify(p), function (assert) {
            var v;
            for (var i=0; i<p.s.length; i++) {
                var segPoints = p.s[i];
                var segment = new JSVTS.Segment({
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("should not change lanes when vehicle in lookahead distance of new lane: " + JSON.stringify(p), function (assert) {
            var v,
                expectedSegmentId;
            for (var i=0; i<p.s.length; i++) {
                var segPoints = p.s[i];
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("should change lanes when vehicle beyond lookahead distance of new lane: " + JSON.stringify(p), function (assert) {
            var v, v2;
            for (var i=0; i<p.s.length; i++) {
                var segPoints = p.s[i];
                var segment = new JSVTS.Segment({
...
for (var i=0; i<cases.length; i++) {
    (function (p) {
        QUnit.test("should not change lanes when vehicle in lookahead distance of new lane on separate segment", function (assert) {
            var v,
                expectedSegmentId;
            for (var i=0; i<p.s.length; i++) {
                var segPoints = p.s[i];
