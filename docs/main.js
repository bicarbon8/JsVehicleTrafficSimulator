...
module.exports = __webpack_require__(/*! C:\Users\smija8k\Documents\Projects\git\GitHub\bicarbon8.github.io\JsVehicleTrafficSimulator\src\main.ts */"zUnb");
...
class AppComponent {
    constructor() {
        this.title = 'JsVehicleTrafficSimulator';
    }
}
...
const routes = [
    { path: '**', loadChildren: () => __webpack_require__.e(/*! import() | src-app-traffic-sim-traffic-sim-module */ "src-app-traffic-sim-traffic-sim-module").then(__webpack_require__.bind(null, /*! src/app/traffic-sim/traffic-sim.module */ "QSF+")).then((m) => m.TrafficSimModule) }
];
